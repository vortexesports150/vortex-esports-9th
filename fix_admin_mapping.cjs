...
const toReplace = "  const effectiveHostId = (hostId === 'playvear_official_giveaway') ? '20268211706164' : hostId;";

const replacement = `  const [effectiveHostId, setEffectiveHostId] = useState<string | null>(null);
...
console.log("Fixed HostProfileModal.tsx admin mapping.");
